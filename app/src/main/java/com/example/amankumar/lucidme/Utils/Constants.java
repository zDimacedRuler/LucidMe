...
public class Constants {
    ...
    public static final String TO_HOUR="to.hour";
    public static final String TO_MINUTE="to.minute";
    public static final String SLEEP_HOUR = "sleep.hour";
    public static final String SLEEP_MINUTE = "sleep.minute";
    public static final String WAKE_HOUR = "wake.hour";
