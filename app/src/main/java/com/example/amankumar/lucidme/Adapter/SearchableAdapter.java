...
public class SearchableAdapter extends ArrayAdapter<Dream>{
    Context context;
    int layoutResourceId;
    ArrayList<Dream> dreams;
    int positionOfDream;
    ArrayList<String> list;
    public SearchableAdapter(Context context, int resource, List<Dream> dreams,ArrayList<String> list) {
    ...
    private class OnItemClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            SearchableActivity activity= (SearchableActivity) context;
            activity.onItemClick(mPosition,mListId);
        }
    }
}
